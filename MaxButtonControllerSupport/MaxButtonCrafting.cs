...
public class MaxButtonCrafting
{
    ...
    private static void SetMinimumAmount(ref CraftItemGUI craftItemGUI)
    {
        SetAmount(ref craftItemGUI, 1);
    }


    private static void SetMaximumAmount(ref CraftItemGUI craftItemGUI, ref WorldGameObject crafteryWgo)
    {
