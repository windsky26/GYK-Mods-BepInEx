...
public partial class Plugin
{
    ...
    [HarmonyPostfix]
    [HarmonyPatch(typeof(ItemCountGUI), nameof(ItemCountGUI.Open), typeof(string), typeof(int), typeof(int), typeof(Action<int>), typeof(int), typeof(ItemCountGUI.PriceCalculateDelegate))]
    public static void Postfix(ref ItemCountGUI __instance, ref ItemCountGUI.PriceCalculateDelegate price_calculate_delegate)
    {
